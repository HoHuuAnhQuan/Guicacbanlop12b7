(function () {
 ...
 ///////////////////   
    ...
    var canopyArea = {
      minX: 445,  // Điều chỉnh vùng bên trái
      maxX: 790,  // Điều chỉnh vùng bên phải
      minY: 130,  // Điều chỉnh vùng phía trên
      maxY: 430   // Điều chỉnh vùng phía dưới
  };
  
  
  function isValidPosition(x, y, size) {
    return x - size / 2 >= canopyArea.minX && x + size / 2 <= canopyArea.maxX &&
           y - size / 2 >= canopyArea.minY && y + size / 2 <= canopyArea.maxY;
}
        ...
        Jscex.compile("async", function () {
            ...
            function loadImage(imgSrc) {
                ...
                img.onload = function () {
                    ...
                    var imageSize = window.innerWidth < 768 ? 40 : 60; 
